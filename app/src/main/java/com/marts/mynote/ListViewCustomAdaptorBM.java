...
public Activity context;
    public ListViewCustomAdaptorBM(Activity context, ArrayList<TaskInfo> itemList, OnClickInMyAdapterListener  myActivityInterface) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        remvbtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                myActivityInterface.removeTaskOnClick(position);
